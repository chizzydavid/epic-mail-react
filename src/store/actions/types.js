...
export const SEND_MSG_FEEDBACK = 'SEND_MSG_FEEDBACK';
...
export const REMOVE_MESSAGE_ALL = 'REMOVE_MESSAGE_ALL';

export const REMOVE_MESSAGE_UNREAD = 'REMOVE_MESSAGE_UNREAD';

export const REMOVE_MESSAGE_READ = 'REMOVE_MESSAGE_READ';

export const REMOVE_MESSAGE_SENT = 'REMOVE_MESSAGE_SENT';
